...
\caption{Selected frames from using a grand tour of mouse retina single cell RNA-seq data with the radial transformation described in @Laa2020-uv. Here the sage display was used to identify and verify cluster sepearation between the three highlighted clusters estimated from a clustering algorithm.}\label{fig:mouse-cluster}
\end{figure}
