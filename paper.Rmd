...
abstract: > 
  This article discusses a high-dimensional visualization technique called the tour, which can be used to view data in more than three dimensions. We review the theory and history behind the technique, as well as modern developments and applications of the tour that are being found across the natural sciences and machine learning. 
keywords:
