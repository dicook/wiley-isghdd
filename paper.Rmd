...
The rest of the review is structured as follows: in section \@ref(notation) we define the notation and components of a tour display, in section \@ref(we review the importance of interactive user ..
...
\begin{figure*}
   \centering
         \includegraphics[width=0.45\textwidth]{figures/scheidigger_nn_tour.png}
          \includegraphics[width=0.45\textwidth]{figures/scheidigger_umap_tour.png}
