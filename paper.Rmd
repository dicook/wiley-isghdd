...
\caption{A selection of views of a slice tour display showing geometric shapes: Roman surface (left), 4D torus (middle) and a 6d cube (right). Adapted from \cite{Laa2020-ni}, Figure 4.}
