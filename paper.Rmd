...
\caption{Selected frames from using a grand tour of the physics experiments data. The three different types of measurements (shown in different colors) are aligned along different directions in parameter space (left). An outlying point is marked with an asterisk symbol (grey) in the ATLAS7new facet (right). Adapted from \cite{Cook2018-jm}, Figures 6 and 7.}
\label{fig:physics}
\end{figure*}
