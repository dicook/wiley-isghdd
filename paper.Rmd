...
\begin{figure*}
   \centering
         \includegraphics[width=0.9\textwidth]{figures/slice_tour_left.pdf}
         \includegraphics[width=0.9\textwidth]{figures/slice_tour_right.pdf}
...
\begin{figure*}
   \centering
         \includegraphics[width=0.5\textwidth]{figures/scheidigger_nn_tour.png}
          \includegraphics[width=0.5\textwidth]{figures/scheidigger_umap_tour.png}
